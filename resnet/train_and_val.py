...
paser.add_option('--mo',dest='nesterov_momentum',type='float',default=0.9)
...
paser.add_option('--lr',dest='learning_rate',type='float',default=0.0001)
...
paser.add_option('-M',dest='MAX_STEP',type='int',default=30000)
    ...
    try:
      ...
      for step in range(MAX_STEP):
        ...
        tra_acc,tra_loss,_=sess.run([acc,loss,train_op],
                                       feed_dict={x:tra_image,y_:tra_label,keep_prob:0.6})
